...
<div id="open-modal" class="modal-window">
  <div>
    ...
    <h1>Bonjour !</h1>
    <div>Le but de ce site est de tirer au sort un champion aléatoire. Vous devrez le jouer obligatoirement dans votre prochaine game. Vous êtes libre du role ou vous voulez jouer le personnage. Amusez vous en normal game avec vos amis !</div>
    <br>
  </div>
</div>
</div>
